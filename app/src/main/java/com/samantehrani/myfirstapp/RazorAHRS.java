...
public class RazorAHRS {
	...
	private class BluetoothThread extends Thread {
		...
		private void initRazor() throws IOException {
			...
			final byte[] contactSynchReply = (SYNCH_TOKEN + contactSynchID + NEW_LINE).getBytes(StandardCharsets.US_ASCII);
			...
			final byte[] configSynchReply = (SYNCH_TOKEN + configSynchID + NEW_LINE).getBytes();
